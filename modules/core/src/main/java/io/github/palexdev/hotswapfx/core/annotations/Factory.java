...
/// Annotation to be used on a method to override the way new nodes are created by the hot swap system
/// (by default, uses no-args constructors)
///
/// _The method annotated by this must have no args!_
